...
function getDefaultState(autoSyncEnabled = true): OfflineSyncSchedulerState {
  return {
...
export function loadOfflineSyncSchedulerState(): OfflineSyncSchedulerState {
...
export function evaluateOfflineSyncSchedulerHealth(
  queue: OfflineQueueSchedulerItem[],
  nowMs: number = Date.now()
): Pick<OfflineSyncSchedulerState, "scheduler_lag_seconds" | "stuck_detected" | "stuck_reason"> {
