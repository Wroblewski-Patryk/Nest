...
use App\Http\Controllers\Api\AccessAuditController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['auth:sanctum', 'delegated.scope', 'actor.context', 'tenant.usage', 'entitlements'])->group(function (): void {
        ...
        Route::get('/auth/access-audits', [AccessAuditController::class, 'index']);
        ...
        Route::get('/auth/ai-agents/{agentId}/credentials', [AiAgentAccountController::class, 'listCredentials']);
