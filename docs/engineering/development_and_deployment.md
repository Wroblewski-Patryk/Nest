...
- `.github/workflows/ci.yml`
  - `api-contract`: OpenAPI lint for `docs/engineering/contracts/openapi_tasks_lists_v1.yaml`
...
- Workflow details: `docs/engineering/quality_gate_workflow.md`
...
- Latest local drill runbook: `docs/operations/backup_restore_drill.md`.
...
- Detailed baseline scope and monitoring:
  - `docs/modules/mobile_push_notifications_baseline.md`
...
- Reference:
  - `docs/modules/analytics_ingestion_pipeline.md`
...
- Reference:
  - `docs/modules/collaboration_spaces_v1.md`
