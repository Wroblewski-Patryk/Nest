...
- contract statement: `docs/backend_strategy.md:50` (queue-first)
...
- architecture docs:
  - `docs/system_architecture.md:43`
  - `docs/system_architecture.md:44`
  - `docs/system_architecture.md:55`
- runtime defaults:
...
- docs describe OpenAPI as contract source: `docs/backend_strategy.md:12`
...
- documented target: `docs/backend_strategy.md:28`
