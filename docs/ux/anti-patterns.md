...
- Treating desktop as a stretched phone with empty margins.
- Using identical cards for everything in planning-heavy views.
- Hiding the next best action behind menus or hover-only affordances.
